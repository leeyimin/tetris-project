...
public class HillClimbTrainer {
    ...
    public HillClimbTrainer(List<Double> coefficients, List<BiFunction<TestableState, TestableState, Integer>> features) {
    ...
    public HillClimbTrainer(List<Double> coefficients, List<BiFunction<TestableState, TestableState, Integer>> features, int numBatches) {
