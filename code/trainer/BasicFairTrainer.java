...
public class BasicFairTrainer extends BasicTrainer {
    ...
    public BasicFairTrainer(List<Double> coefficients, List<Function<PlayerSkeleton.TestState, Double>> features, int numIterations) {
        super(coefficients, features, numIterations);
    }

    public static BasicFairTrainer getTrainerResults(List<Double> coefficients, List<Function<PlayerSkeleton.TestState, Double>> features, int numIterations){
